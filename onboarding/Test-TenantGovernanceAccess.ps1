...
.NOTES
    ...
    TEST_REQUIRED:
      ...
      - policySnapshot role verification checks group IDs in governing  confirm IDstenant 
...
# Source: AzLighthouse/lighthouse/lighthouse-offer1.json + New-TenantGovernanceRelationship.ps1
# TEST_REQUIRED: Verify these match live RSOC tenant group object IDs
$ExpectedGroupIds = @(
    @{ Id = 'c1f4a285-1b26-46b8-9a97-d298861ad503'; Name = 'RSOC_Sentinel_Admin' },
    @{ Id = 'cbe65060-f79c-4350-aaf2-fd901a95de33'; Name = 'RSOC_Sentinel_Onboarding' },
    @{ Id = '440ba293-8d18-430c-b4cc-3ea789d655e9'; Name = 'RSOC_Sentinel_Threat_Detection_Engineering_Tier1' },
    @{ Id = 'd4e11e0e-6300-4491-938f-e934a587f990'; Name = 'RSOC_Sentinel_Threat_Detection_Engineering_Tier2' },
    @{ Id = '4fd628b1-a5f8-43a1-9949-88a84e7f053b'; Name = 'RSOC_Sentinel_Security_Engineers' },
    @{ Id = 'a6539c63-c61b-459f-bdc6-22106aa0aed3'; Name = 'RSOC_Sentinel_Red_Team' },
    @{ Id = 'ef18438b-79fc-4b4a-8f3f-3b691f091aa2'; Name = 'RSOC_Sentinel_Incident_Response' },
    @{ Id = '0d593b30-eb20-4d83-a7eb-deff71e401d2'; Name = 'RSOC_Sentinel_Incident_Detection_Tier1' },
    @{ Id = 'fe773eea-b69d-40e7-9c90-0ccb5ea4447c'; Name = 'RSOC_Sentinel_Incident_Detection_Tier2' }
)
...
if ($activeRel -and $activeRel.policySnapshot) {
    ...
    Write-Host "  WARNING: Active relationship has no  cannot verify role assignments" -ForegroundColor YellowpolicySnapshot 
...
Write-Host "=== Result: $(if ($allPassed) { 'ALL CHECKS PASSED' } else { 'CHECKS  review above' })" `FAILED 
...
Write-Evidence @{
    ...
    testRequired        = @(
        "API is Graph  verify endpoints before production run",beta 
        "Run from RSOC governing tenant context",
