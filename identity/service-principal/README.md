# Deploy Service Principal from the MSSP tenant using the User Assigned Identity

The template below leverages the user assigned identity created by the customer.
